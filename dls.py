...
def move_tile(puzzle, direction):
    ...
    if direction == 'up' and blank_row > 0:
        new_puzzle[blank_row][blank_col], new_puzzle[blank_row - 1][blank_col] = new_puzzle[blank_row - 1][blank_col], new_puzzle[blank_row][blank_col]
    elif direction == 'down' and blank_row < 2:
        new_puzzle[blank_row][blank_col], new_puzzle[blank_row + 1][blank_col] = new_puzzle[blank_row + 1][blank_col], new_puzzle[blank_row][blank_col]
    elif direction == 'left' and blank_col > 0:
        new_puzzle[blank_row][blank_col], new_puzzle[blank_row][blank_col - 1] = new_puzzle[blank_row][blank_col - 1], new_puzzle[blank_row][blank_col]
